import"./assets/header-1301d940.js";/* empty css                     */import{n as r}from"./assets/data-news-fe2df6bb.js";import"./assets/main-form-80133312.js";const o=document.querySelector("#news-list"),u=document.querySelector(".news"),t=document.querySelector(".news-pagination-list"),h=document.querySelector("#next-page-btn"),w=document.querySelector(".news-nav-list");let d=Math.ceil(r.length/6),c="all",i=1;function m(e,s="all"){let n=0;s==="all"?n=e:n=e.filter(g=>g.type.toLowerCase()===s.toLowerCase());const a=n.slice((i-1)*6,i*6).reduce((g,l)=>g+`
    <li class="news-card">
      <img
        class="news-card-img"
        src="${l.img}"
