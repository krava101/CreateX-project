import"./assets/header-4ffb22f8.js";/* empty css                     */import"./assets/comments-accae290.js";import{p as l}from"./assets/data-projects-2fb17aac.js";const n=document.querySelector(".projects-list"),m=document.querySelector(".media-list"),p=document.querySelectorAll(".media-btn"),s=document.querySelector(".projects-load-more");let r=1;const o=(e="all",c=1)=>{s.style.display="flex",c*9>=l.length&&(s.style.display="none");let i=l.slice(0,c*9);e!=="all"&&(i=l.filter(a=>a.status===e),s.style.display="none");const d=i.reduce((a,t)=>a+`<li class="projects-card">
        <img
          class="projects-img"
          src="${t.previewImg}"
          alt="${t.name}"
