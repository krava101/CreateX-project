export const projects = [
  ...
  },
  {
    ...
    value: "$50 million",
    completed: "2019",
    description: 'Ilot Balmoral, developed by Societe d’Habitation de Montréal (SHDM) and designed by Provencher Roy, a 13-floor mixed-use office building is part of the "Quartier des Spectacles" located in Ilot Balmoral, Montréal. Ilot Balmoral is home to National Film Board (NFB) head office explicitly designed for its filmmaking activities.',
    previewImg: new URL('/img/work-page-img/project-7.jpg', import.meta.url).href,
    images: [`${new URL('/img/project-img/7-project-1.jpg', import.meta.url).href}`, `${new URL('/img/project-img/7-project-2.jpg', import.meta.url).href}`, `${new URL('/img/project-img/7-project-3.jpg', import.meta.url).href}`, `${new URL('/img/project-img/7-project-4.jpg', import.meta.url).href}`, `${new URL('/img/project-img/7-project-5.jpg', import.meta.url).href}`, `${new URL('/img/project-img/7-project-6.jpg', import.meta.url).href}`]
  },
  {
    id: 7,
    ...
    type: "Private houses",
    status: "design",
    location: "203 Thomas More Street, Wapping, E1W 1YD, England, United Kingdom",
    client: "CoTG Group",
    architect: "Scandinavian",
    size: "27 sqm",
    value: "$50 thousand",
    completed: "2022",
    description: "Scandinavian style interior design is a popular and distinctive aesthetic that emanates from the Nordic countries - Denmark, Norway, Sweden, Finland, and Iceland. Known for its simplicity, functionality, and emphasis on natural elements, the Scandinavian style has gained global appeal for creating cozy and inviting spaces.",
    previewImg: new URL('/img/work-page-img/project-8.jpg', import.meta.url).href,
    images: [`${new URL('/img/project-img/8-project-1.jpg', import.meta.url).href}`, `${new URL('/img/project-img/8-project-2.jpg', import.meta.url).href}`, `${new URL('/img/project-img/8-project-3.jpg', import.meta.url).href}`, `${new URL('/img/project-img/8-project-4.jpg', import.meta.url).href}`, `${new URL('/img/project-img/8-project-5.jpg', import.meta.url).href}`, `${new URL('/img/project-img/8-project-6.jpg', import.meta.url).href}`]
  },
  {
    id: 8,
    ...
    value: "$1.7 million",
    completed: "2021",
    description: "Scandinavian style is a popular and distinctive aesthetic that emanates from the Nordic countries - Denmark, Norway, Sweden, Finland, and Iceland. Known for its simplicity, functionality, and emphasis on natural elements, the Scandinavian style has gained global appeal for creating cozy and inviting spaces.",
    previewImg: new URL('/img/work-page-img/project-9.jpg', import.meta.url).href,
    images: [`${new URL('/img/project-img/9-project-1.jpg', import.meta.url).href}`, `${new URL('/img/project-img/9-project-2.jpg', import.meta.url).href}`, `${new URL('/img/project-img/9-project-3.jpg', import.meta.url).href}`, `${new URL('/img/project-img/9-project-4.jpg', import.meta.url).href}`, `${new URL('/img/project-img/9-project-5.jpg', import.meta.url).href}`, `${new URL('/img/project-img/9-project-6.jpg', import.meta.url).href}`]
  }
]