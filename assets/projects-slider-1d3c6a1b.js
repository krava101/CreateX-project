import{p as i}from"./data-projects-2fb17aac.js";const t=document.getElementById("p-list"),p=document.getElementById("p-left-btn"),h=document.getElementById("p-right-btn"),m=document.getElementById("p__title");let e=0,o;const j=window.location.pathname,u={"/CreateX-project/index.html":"Browse our selected projects and learn more about our work","/CreateX-project/service.html":"Related projects","/CreateX-project/project.html":"Similar projects","/index.html":"Browse our selected projects and learn more about our work","/service.html":"Related projects","/project.html":"Similar projects"};m.textContent=u[j];const f=(r,c)=>{let l=i;r&&(l=i.filter(n=>n.type===r.type&&n.name!==r.name)),c&&(l=i.filter(n=>n.status===c));const d=l.reduce((n,s)=>n+`<li class="projects__card">
        <img
...
//# sourceMappingURL=projects-slider-1d3c6a1b.js.map
