import{p as l}from"./assets/data-projects-3a722654.js";/* empty css                     */import{a as i}from"./assets/similar-projects-ebbc83be.js";import{l as u}from"./assets/comments-a49f048a.js";const m=document.querySelector(".application-form"),p=document.querySelector(".question-form"),d=document.querySelector(".hero-steps-list"),g=document.querySelector(".hero-left-btn"),h=document.querySelector(".hero-right-btn"),a=document.querySelector(".hero-pag-list"),v=document.querySelector("#p-list");let r=0;const t={userName:"",phone:"",email:"",message:"",receive:""},s={userName:"",phone:"",message:""};function f(){const e=l.reduce((c,o)=>c+`
