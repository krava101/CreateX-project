import"./assets/header-4ffb22f8.js";/* empty css                     */import{p as n}from"./assets/data-projects-2fb17aac.js";import{l as s}from"./assets/projects-slider-a7d0a2f1.js";import{t as m}from"./assets/touch-slider-a3d169cb.js";const p=window.location.href,g=new URL(p),j=+g.searchParams.get("project"),t=n[j],a=document.getElementById("project-title"),d=document.getElementById("project-path"),y=document.getElementById("project-gallery"),u=document.getElementById("project-small-gallery"),_=document.getElementById("project-info"),h=document.getElementById("project-description");a.textContent=t.name;a.classList.remove("project__title_loader");d.textContent=`/ ${t.name}`;y.innerHTML=`
  <li>
